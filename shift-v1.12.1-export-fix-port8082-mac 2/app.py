...
def init():
 ...
 c.execute("""CREATE TABLE IF NOT EXISTS shifts(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,staff_id INTEGER,work_date TEXT,start TEXT,"end" TEXT,break_min INTEGER DEFAULT 0,break_start TEXT,break_"end" TEXT,UNIQUE(staff_id,work_date))""")
